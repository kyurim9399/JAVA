...
<body>
	<div id="reviewMain">
		...
		<div class="row">
			<div class="left">회원ID</div><div class="right">${sessionScope.userId }</div>
		</div>
		<div class="row">
			<div class="left">제목</div><div class="right"><input type="text" name="title" id="title" /></div>
		</div>
		<div class="row">
		...
		<div id="row_contents">
			<div class="left"><br /><br />내용</div>
			<div class="right" style="padding-top: 2px;">
				<textarea name="contents" id="contents" style="resize: none;"cols="100" rows="13" ></textarea>
			</div>
		</div>
		<div id="lastrow">
			<input type="button" value="등록하기" id="go" />
